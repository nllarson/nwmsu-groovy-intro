...
const images = {
  ...
  nwmsu: require('../assets/nwmsu.png')
}
      ...
      <Spectacle theme={theme}>
        <Deck transition={['zoom', 'slide']} transitionDuration={500} progress="bar">
          ...
          <Slide transition={['zoom']} bgColor="lightgrey">
            ...
            <Heading>
              <Image width="400px" src={images.opiLogo} />
            </Heading>
            <List>
              <ListItem>@nllarson</ListItem>
              <ListItem>nicklas.larson@gmail.com</ListItem>
              <ListItem>
                <Link href="https://github.com/nllarson/nwmsu-groovy-intro" textColor="black">
                  https://github.com/nllarson/nwmsu-groovy-intro
                </Link>
              </ListItem>              
            </List>
            <Image src={images.nwmsu} width="100px"/><Text caps>#OABAAB -- BS-CS 2002</Text>
          </Slide>
          <Slide
            transition={['zoom', 'fade']}
            bgColor="lightgrey"
            notes="Builds upon the strengths of Java but has additional power features inspired by languages like Python, Ruby and Smalltalk"
          >
            <BlockQuote>
              <Quote textColor="black" textSize="35px">
                Groovy is a powerful, optionally typed and dynamic language, with static-typing and static compilation
                capabilities, for the Java platform aimed at improving developer productivity thanks to a concise,
                familiar and easy to learn syntax. It integrates smoothly with any Java program, and immediately
                delivers to your application powerful features, including scripting capabilities, Domain-Specific
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            <Text caps>
              <b>String</b> literal uses single quotes
            </Text>
            <CodePane
              textSize="23px"
              lang="groovy"
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            <Text caps>
              Groovy Strings aka <b>GStrings</b>
            </Text>
            <List>
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            ...
            <List>
              ...
              <ListItem>
                return type is optional - use <b>def</b> keyword
              </ListItem>
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            ...
            <List>
              <Appear>
                <ListItem margin="20px auto">
                  <Code>null</Code>, <Code>0</Code>, <Code>''</Code>, <Code>[]</Code>, <Code>[:]</Code> evaluate to
                  FALSE
                </ListItem>
              </Appear>
              <Appear>
                <ListItem margin="20px auto">
                  <Code>==</Code> is the equivelent of <Code>a.equals(b)</Code>
                </ListItem>
              </Appear>
              <Appear>
                <ListItem margin="20px auto">
                  If <Code>Comparable</Code>, <Code>a.compareTo(b)==0</Code>
                </ListItem>
              </Appear>
            </List>
          </Slide>
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey" align="center flex-start">
            ...
            <CodePane
              ...
              margin="5px auto"
            />
            <Link href="http://groovy-lang.org/operators.html#Operator-Overloading">
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            ...
            <List>
              <ListItem>
                <Code>.sort()</Code> can be called on any collection
              </ListItem>
              <ListItem>
                <Code>.sort()</Code> can take a closure, no comparators
              </ListItem>
              <ListItem>
                <Code>.sort(false)</Code> does not modify the collection
              </ListItem>
            </List>
            <CodePane
              fit
          ...
          <Slide
            ...
            bgColor="lightgrey"
            notes="Modifying metaclass can be useful for framework development, but can also be confusing"
          >
            <Text caps>MetaClass Object Example</Text>
            <Text fit>
              Add an addQuestionMark method to a String object that adds a question mark to the end of the string
            </Text>
            <Appear>
              <CodePane
                fit
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            <Text fit>
              Traits are great for adding reusable capabilities to a class without requiring large inheritance tree
            </Text>
            <Text textAlign="center" margin="20px auto">
              Public fields
            </Text>
            <Text textAlign="center" margin="20px auto">
              Methods
          ...
          <Slide transition={['slide', 'fade']} bgColor="lightgrey">
            ...
            <List>
              <ListItem>
                <Link href="http://groovy-lang.org" textColor="black">
                  http://groovy-lang.org
                </Link>
              </ListItem>
              <ListItem>
                <Link href="http://stackoverflow.com/tags/groovy/info" textColor="black">
                  http://stackoverflow.com/tags/groovy/info
                </Link>
              </ListItem>
              <ListItem>
                <Link href="http://www.manning.com/koenig2/" textColor="black">
